...
<body>
    ...
    <section class="hero-bg text-white text-center" style="height: 420px;">
        ...
        <div class="hero-content d-flex align-items-center justify-content-center h-100">
            <div class="container" style="max-width: 1200px;">
                <h1 class="display-4" style="font-size: 44px; line-height: 1.2;">Découvrez la flore locale</h1>
                <p class="lead" style="font-size: 18px; opacity: 0.9; max-width: 640px; margin: 24px auto 48px;">Explorez les trésors botaniques de Saint-Martin-de-Londres.</p>
            </div>
        </div>
    </section>

    <!-- Explorer l'atlas -->
    <section id="explorer" class="atlas-section">
        <div class="container" style="max-width: 1200px;">
    ...
    <!-- Milieux naturels -->
    <section id="milieux" class="py-5">
        <div class="container" style="max-width: 1200px;">
            <h2 class="text-center mb-4">Milieux naturels</h2>
            <div class="row g-3">
    ...
    <!-- Saisons -->
    <section id="saisons" class="saisons-bg py-5">
        <div class="container" style="max-width: 1200px;">
    ...
    <!-- Focus local -->
    <section id="focus" class="focus-bg py-5">
        <div class="container" style="max-width: 1200px;">
            <div class="row">
    ...
    <section id="random" class="random-bg text-white text-center py-5">
        <div class="container">
